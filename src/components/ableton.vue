    ...
    <div class="header pt-5 pr-[17px] ">
        <div class="header-1 ">
            ...
            <div class="mb-4  2xl:hidden">
                <button class="text-md font-bold">Menu<span class="p-[5px] mr-2 mb-[-3px]"><i class="text-xs  fa-solid fa-angle-down"></i></span></button>
            </div>
